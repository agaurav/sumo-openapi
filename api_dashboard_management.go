...
*/
func (a *DashboardManagementApiService) CreateDashboard(ctx _context.Context) ApiCreateDashboardRequest {
	return ApiCreateDashboardRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return Dashboard
func (a *DashboardManagementApiService) CreateDashboardExecute(r ApiCreateDashboardRequest) (Dashboard, *_nethttp.Response, error) {
	var (
...
*/
func (a *DashboardManagementApiService) DeleteDashboard(ctx _context.Context, id string) ApiDeleteDashboardRequest {
	return ApiDeleteDashboardRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *DashboardManagementApiService) DeleteDashboardExecute(r ApiDeleteDashboardRequest) (*_nethttp.Response, error) {
	var (
...
*/
func (a *DashboardManagementApiService) GetDashboard(ctx _context.Context, id string) ApiGetDashboardRequest {
	return ApiGetDashboardRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return Dashboard
func (a *DashboardManagementApiService) GetDashboardExecute(r ApiGetDashboardRequest) (Dashboard, *_nethttp.Response, error) {
	var (
...
*/
func (a *DashboardManagementApiService) UpdateDashboard(ctx _context.Context, id string) ApiUpdateDashboardRequest {
	return ApiUpdateDashboardRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return Dashboard
func (a *DashboardManagementApiService) UpdateDashboardExecute(r ApiUpdateDashboardRequest) (Dashboard, *_nethttp.Response, error) {
	var (
