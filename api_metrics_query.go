...
func (r ApiRunMetricsQueriesRequest) Execute() (MetricsQueryResponse, *_nethttp.Response, error) {
...
*/
func (a *MetricsQueryApiService) RunMetricsQueries(ctx _context.Context) ApiRunMetricsQueriesRequest {
	return ApiRunMetricsQueriesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *MetricsQueryApiService) RunMetricsQueriesExecute(r ApiRunMetricsQueriesRequest) (MetricsQueryResponse, *_nethttp.Response, error) {
	var (
